export const legalRu = {
  ...
  privacy: {
    meta: {
      ...
      description:
        "Как Presence защищает вашу приватность и обрабатывает данные с Privacy-first AI.",
    },
    title: "Политика конфиденциальности",
    intro:
      "Presence создан вокруг доверия. Мы помогаем вам представить профессиональный опыт — и берём на себя ответственность за то, как обрабатываются ваши данные. Эта политика объясняет простым языком, что мы собираем, что никогда не передаём, и как работает анализ.",
    ...
    sections: {
      ...
      neverSent: {
        ...
        body: [
          ...
          "Presence использует Privacy-first AI: персональные данные заменяются стабильными плейсхолдерами до запроса. В OpenAI уходит только анонимизированный профессиональный опыт.",
        ],
      },
      ai: {
  ...
  personalData: {
    meta: {
      ...
      description: "Как Presence обрабатывает персональные данные пользователей.",
    },
    title: "Обработка персональных данных",
    intro:
      "Этот документ описывает категории персональных данных, цели и правовые основания обработки. Presence относится к данным ответственно — прозрачность для нас часть продукта.",
    updated: "26 июня 2025",
    sections: {
      types: {
      ...
      legal: {
        ...
        body: [
          ...
          "Исполнение договора (оказание услуг Presence).",
  ...
  terms: {
    meta: {
      ...
      description: "Правила использования платформы Presence.",
    },
    title: "Условия использования",
    intro:
      "Presence — платформа профессиональной идентичности. Эти условия определяют, как вы можете пользоваться сервисом. Мы пишем их понятным языком, без лишней бюрократии.",
    updated: "26 июня 2025",
    sections: {
      service: {
        title: "Описание сервиса",
        body: [
          "Presence превращает резюме в структурированный CareerProfile и карьерное портфолио с помощью AI.",
      ...
      aiLimits: {
        ...
        body: [
          ...
          "Presence не гарантирует точность каждого поля — проверяйте результат.",
      ...
      noGuarantee: {
        ...
        body: [
          "Presence не гарантирует собеседования, офферы или трудоустройство.",
      ...
      ip: {
        ...
        body: [
          ...
          "Дизайн, код и бренд Presence — собственность правообладателя сервиса.",
        ],
      },
      liability: {
        ...
        body: [
          ...
          "Presence не несёт ответственности за косвенные убытки, связанные с использованием сервиса.",
        ],
      },
      termination: {
        title: "Прекращение",
  ...
  cookies: {
    meta: {
      ...
      description: "Как Presence использует cookies.",
    },
    title: "Политика cookies",
    intro:
    ...
    sections: {
      ...
      why: {
        ...
        body: [
          "Сейчас Presence использует только essential cookies, необходимые для работы.",
  ...
  contact: {
    meta: {
      title: "Контакты",
      description: "Связаться с командой Presence.",
    },
    title: "Контакты",
    intro:
  ...
  status: {
    meta: {
      ...
      description: "Текущее состояние компонентов Presence.",
    },
    title: "Статус сервиса",
  ...
  roadmap: {
    meta: {
      title: "Roadmap",
      description: "План развития Presence — Career Intelligence Platform.",
    },
    title: "Roadmap",
    intro:
      "Presence строит Digital Professional Identity. Каждый этап расширяет CareerProfile — резюме парсится только один раз.",
    stages: [
  ...
  changelog: {
    meta: {
      title: "Changelog",
      description: "История изменений Presence.",
    },
    title: "Changelog",
    intro: "Что нового в Presence — кратко и по делу.",
    entries: [
      {
        version: "Alpha 0.1",
